	...
	public function forgetPassMail()
	{
		...
		$message = 
			'<html>
				...
				<body>
					Bonjour ' . htmlspecialchars($_SESSION['username']) . ', pour réinitialiser votre mot de passe, accédez au lien suivant : <a href="http://localhost/Blog_Avril_Laurent/passForgotten&user_id=' .  htmlspecialchars($_SESSION['id']) . '&cookie_token=' . $_COOKIE['token'] . '">Changer de mot de passe</a>
				</body>
			</html>';
